...
class NewIndexView(generic.ListView):
    template_name = "comic_app/newindex.html"
    context_objects_name = "title_list"
    queryset = Title.objects.order_by('watch_date').reverse()[:3]


class SubPageView(generic.ListView):
    model = Title
    template_name = "comic_app/subpage.html"
